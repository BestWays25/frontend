...
const Cart = () => {
   ...
   useEffect( () => {
    ...
    return (
        <>
        <HomeLayout>
        <div id="cart" className='container-fluid py-5 mt-5'>
                            ...
                            <tbody>
                                    {
                                        data && data.map( (item,index) => {
                                            ...
                                            return(
                                                <tr className='align-middle table-flex' key={index}>
                                                <td>
                                                <LazyLoadImage effect="blur" className='img-cart' src={Imagesrc} alt={item.product.name} />
                                                ...
                                                <td>
                                                    ...
                                                    }}  className='btn btn-outline-warning ms-2'>Remove</button>
                                                </td>
                                            </tr>
                                            )
                                        })
