                ...
                <>
                  <div className="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <ul className="nav text-light flex-column">
                      ...
                      <li className="nav-item mb-2"><a href="/login" className="nav-link p-0 link-light">Sign In</a></li>
                      <li className="nav-item mb-2"><a href="/Search" className="nav-link p-0 link-light">New Products</a></li>
                      <li className="nav-item mb-2"><a href="/Search" className="nav-link p-0 link-light">Offers</a></li>
                    </ul>
                  </div>
                  <div className="col-xs-12 col-sm-6 col-md-3">
                    <h5>Guids</h5>
                    <ul className="nav flex-column">
                      <li className="nav-item mb-2"><a href="/register" className="nav-link p-0 link-light">Getting Started</a></li>
