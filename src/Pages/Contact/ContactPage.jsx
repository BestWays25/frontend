...
const ContactPage = () =>{
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('gmail', 'template_i75fu4h', e.target, 'QqgfhxPtuQbEJGM-n')
          .then((result) => {
                    ...
                    <div className="contact">
                        ...
                        <div className="form">
                            ...
                            <form >
                                ...
                                <button type="submit" onSubmit={sendEmail}>Send Email <i className="fa fa-paper-plane"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
