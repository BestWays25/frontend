                                        ...
                                        <div className="container justify-content-center align-items-center">
                                            <form className="needs-validation" novalidate>
                                                <div className="row g-3">
                                                    ...
                                                    <label for="Product" className="form-label fw-bold">Select Product<span className="text-danger"> *</span></label>
                                                    ...
                                                    <div className="col-sm-6">
                                                    <label for="Product" className="form-label fw-bold">Select option<span className="text-danger"> *</span></label>
                                                        <select className="form-select" id="product" required >
                                                        <option value="">Choose...</option>
                                                    ...
                                                    <div className="col-sm-6">
                                                        <label for="firstName" className="form-label fw-bold">price increase<span className="text-danger"> *</span></label>
                                                    ...
                                                    <div className="col-sm-6">
                                                        <label for="lastName" className="form-label fw-bold">Option Entity<span className="text-danger"> *</span></label>
